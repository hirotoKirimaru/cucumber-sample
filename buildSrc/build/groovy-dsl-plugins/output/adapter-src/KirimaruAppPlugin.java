...
/**
 * Precompiled kirimaru.app script plugin.
 **/
public class KirimaruAppPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_KirimaruApp").asSubclass(BasicScript.class);
